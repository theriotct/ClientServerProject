										    ...
										    while ($row = mysqli_fetch_assoc($result)) {
											    if($row['isSentByMe'] == 1) {
													...
													echo '<div class="chat-message-right mb-4">
														<div>
															<img src="image.php?userID=' . (int)$user_data['userID'] . '" class="rounded-circle mr-1" alt="'.$user_data['username'].'" width="40" height="40">
												    ...
												    echo '<div class="chat-message-left pb-4">
														<div>
															<img src="image.php?userID=' . (int)$contact_data['userID'] . '" class="rounded-circle mr-1" alt="'.$contact_data['username'].'" width="40" height="40">
															<div class="text-muted small text-nowrap mt-2">'.$row['date'].'</div>
														</div>
